        ...
        if success:
            ...
            if xy.shape == (1,13,3):
                ...
                if df.loc[0,'left_elbow_angle']>-2.5:
                    if not take_off:
                        #send command to drone to take off
                        take_off=True
                        pass
                    ...
                    if df.loc[0,'right_arm_angle']<3.75 and df.loc[0,'right_arm_angle']>1:#typo the feature should be left_arm_angle, but i misnamed it to right_arm_angle
                        #land
                        pass
