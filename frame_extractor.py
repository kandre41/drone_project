...
# Calculate how many frames to skip to get 2 FPS
...
while cap.isOpened():
    ...
    # Save the frame
    cv2.imwrite(f'W:\\VSCode\\drone_project\\datasets\\images\\{video_name}\\{video_name}_frame_{saved_count}.jpg', frame)
